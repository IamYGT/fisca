...
class ErrorBoundary extends Component {
  ...
  render() {
    ...
    if (this.state.hasError) {
      return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900", children: /* @__PURE__ */ jsx("div", { className: "max-w-xl w-full mx-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-red-600 dark:text-red-400 mb-4", children: "Bir Hata Oluştu" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-300 mb-4", children: "Sayfa yüklenirken beklenmeyen bir hata oluştu. Lütfen sayfayı yenileyin veya daha sonra tekrar deneyin." }),
        /* @__PURE__ */ jsx("div", { className: "bg-gray-50 dark:bg-gray-900 rounded p-4 mb-4", children: /* @__PURE__ */ jsx("pre", { className: "text-sm text-gray-800 dark:text-gray-200 whitespace-pre-wrap", children: (_a = this.state.error) == null ? void 0 : _a.message }) }),
        /* @__PURE__ */ jsx(
          "button",
          {
...
function Index({ auth, tickets, filters = {}, statuses, priorities, categories, stats }) {
  ...
  const resetFilters = () => {
    reset();
    const defaultRoute = route("management.admin.tickets.index");
    if (defaultRoute) {
      router.get(defaultRoute, defaultFilters);
    } else {
      console.error("Route bulunamadı: management.admin.tickets.index");
    }
  };
  const applyFilters = (newData) => {
    const targetRoute = route("management.admin.tickets.index");
    if (!targetRoute) {
      console.error("Route bulunamadı: management.admin.tickets.index");
      return;
    }
  ...
  return /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxs(Authenticated, { auth, children: [
              ...
              "tr",
              {
                ...
                children: [
                      ...
                      /* @__PURE__ */ jsx(
                        "div",
                        {
                          ...
                          onClick: () => {
                            ...
                            router.get(route("managment.admin.tickets.index", { search: ticket.user.name }));
                          },
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-right text-sm", children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end space-x-3", children: /* @__PURE__ */ jsx(
                    Link,
                    {
                      href: route("management.admin.tickets.show", ticket.id),
