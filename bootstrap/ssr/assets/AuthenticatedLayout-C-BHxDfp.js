...
import { u as useOnClickOutside, L as LanguageSelector, T as ThemeToggle, A as ApplicationLogo, g as getTheme, s as setTheme } from "./ApplicationLogo-Cm2He-vj.js";
...
const Dropdown = memo(({ isOpen, onClose, children, className = "", triggerRef }) => {
  ...
  useOnClickOutside(ref, onClose, triggerRef ? [triggerRef] : void 0);
