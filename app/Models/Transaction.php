...
class Transaction extends Model
{
    ...
    // İşlem geçmişi için yeni bir tip ekleyelim
    const HISTORY_TYPE_STATUS_CHANGE = 'status_change';
    const HISTORY_TYPE_USER_ACTION = 'user_action';
    const HISTORY_TYPE_SYSTEM = 'system';
    ...
    public function addToHistory(string $messageKey, string $type = self::HISTORY_TYPE_SYSTEM, ?array $params = null)
    {
    ...
    // Transaction modelinde iptal işlemi için yardımcı metod ekleyelim
